...
import { homeAboutImage } from "@/lib/site-images";
  ...
  return (
    <div>
      <PageHero>
        ...
        <p className="mt-4 max-w-xl text-stone-200 text-lg">
        ...
        <div className="mt-8 flex flex-wrap gap-4">
          ...
          <Link
            href="/catalogue"
            className="rounded-lg border border-stone-400 px-6 py-3 font-semibold hover:bg-stone-800/60"
          >
